...
class mesg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mesg
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mesg
    let len;
    let data = new mesg(null);
